...
STREAMLIT_APPS = {
    "TWIFO Import Dropbox": {
        ...
        "port": 8001,  # Changed from 8502 (Dropbox filtering system)
...
PORTS = {
    ...
    "TWIFO Import Dropbox": ("127.0.0.1", 8001),  # Streamlit (Dropbox filtering)
...
def launch_streamlit_app(name: str, config: Dict) -> Optional[subprocess.Popen]:
    ...
    # Streamlit command: streamlit run app.py --server.port PORT
    streamlit_cmd = [
